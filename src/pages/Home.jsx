...
const Home = () => {
	return (
		<>
			<div
				id="/"
				className="font-acorn h-full bg-[#FCF6F5] text-[#2D2E32]"
			>
					...
					<div className="hero-text flex flex-col mt-10 lg:mt-24 ">
						...
						<h2 className="text-black-500 text-[#2D2E32] sm:mb-5">
							<motion.div
								...
								className="px-3 text-black-500 font-semibold text-center text-[#4b0908] lg:py-3.5 lg:text-left"
							>
								<p className="px-4 text-[#2D2E32] text-[2rem] text-center font-poppins font-bold lg:text-left lg:text-[3rem] lg:px-3.5">
									Front End Developer
								</p>
							</motion.div>
						</h2>
				...
				{/* Tech Stack Section */}
				<div className="text-stack-main lg:mt-18">
